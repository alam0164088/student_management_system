...
DEBUG = False  # লোকাল টেস্টের জন্য True করে চেষ্টা করতে পারেন
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # টেমপ্লেট ফোল্ডার যোগ করা
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = BASE_DIR / 'staticfiles'  # STATIC_ROOT যোগ করা
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'  # Whitenoise এর জন্য
